...
export const metadata: Metadata = {
  title: 'Galeria',
  description: 'Fotos, videos y albumes de Cabanas Playa Terco en Playa Terco, Nuqui.',
};
...
const fallbackItems: GalleryItem[] = [
  {
    ...
    caption: 'Cabanas entre selva y mar para bajar el ritmo.',
    category: 'cabins',
    category_label: 'Cabanas',
    type: 'image',
